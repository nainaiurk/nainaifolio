          ...
          child: ConstrainedBox(
            ...
            child: FutureBuilder<List<Uint8List>>(
              ...
              builder: (context, snap) {
                ...
                // Decide whether to enable pinch-to-zoom based on layout width.
                // Mobile/tablet: allow zoom. Desktop (wide layouts): disable zoom.
                final allowZoom = contentWidth <= 900.0;
